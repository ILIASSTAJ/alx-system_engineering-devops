...
Open the Command Prompt application on your Windows system.
Familiarize yourself with basic CMD commands such as cd, dir, mkdir, copy, del, echo, etc. These commands will be the building blocks for solving the challenge problems.
Read the problem statement provided for each challenge carefully. Understand the requirements, constraints, and expected output.
Write CMD commands or a series of CMD commands that solve the problem based on your understanding of the requirements.
Test your solution directly in the CMD environment to verify its correctness.
Iterate and refine your solution until you achieve the desired results.
Repeat the process for each challenge problem.
Tips for Success
...
License
The CMD Challenge is released under the MIT License. Feel free to use, modify, and distribute the challenge as per the terms of the license.
...
so try hard to understand this concepts thanks 
